    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-5">
      {filteredCountries.map((country) => (
        <Link key={country.cca2} href={`/countries/${country.cca2}`}>
          <div className="cursor-pointer bg-DarkBlueDarkModeElements dark:bg-WhiteDarkModeTextnLightModeElements text-WhiteDarkModeTextnLightModeElements dark:text-VeryDarkBlueLightModeText rounded shadow">
