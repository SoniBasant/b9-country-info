...
const menuStyle = {
  dropdownContainer: 'max-w-[181px] relative inline-block text-left shadow',
  downIcon: '-mr-1 h-5 w-5 text-gray-400',
  menuItemStyle: 'flex flex-left px-4 py-2 text-belowSize text-VeryLightGrayLightModeBackground dark:text-DarkGrayLightModeInput data-[focus]:bg-gray-100 data-[focus]:text-gray-900',
