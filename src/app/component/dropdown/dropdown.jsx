...
const menuStyle = {
  ...
  menuItemStyle: 'w-full flex flex-left px-6 py-2 text-belowSize text-VeryLightGrayLightModeBackground dark:text-DarkGrayLightModeInput data-[focus]:bg-gray-100 data-[focus]:text-gray-900',
}