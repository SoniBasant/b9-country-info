...
const menuStyle = {
  ...
  menuButtonStyle: "inline-flex w-full justify-center gap-x-3 rounded-md bg-DarkBlueDarkModeElements dark:bg-WhiteDarkModeTextnLightModeElements px-3 py-3 text-belowSize text-VeryLightGrayLightModeBackground dark:text-DarkGrayLightModeInput shadow-sm ring-inset ring-gray-300",
}