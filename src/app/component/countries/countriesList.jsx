...
export default function CountriesList() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-5 px-6">
      {countries.map((country) => (
        <div key={country.cca3} className="bg-white rounded shadow">
          <img src={country.flags.png} alt={`${country.name.common} flag`} className="w-full h-32 object-cover rounded-t mb-2" />
